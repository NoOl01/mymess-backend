...
const (
	ProfileService_Update_FullMethodName = "/profile.ProfileService/Update"
	ProfileService_Ping_FullMethodName   = "/profile.ProfileService/Ping"
)
...
type ProfileServiceClient interface {
	Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*BaseResultResponse, error)
...
func (c *profileServiceClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*BaseResultResponse, error) {
...
func (c *profileServiceClient) Ping(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*BaseResultResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BaseResultResponse)
	err := c.cc.Invoke(ctx, ProfileService_Ping_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProfileServiceServer interface {
	Update(context.Context, *UpdateRequest) (*BaseResultResponse, error)
...
func (UnimplementedProfileServiceServer) Update(context.Context, *UpdateRequest) (*BaseResultResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedProfileServiceServer) Ping(context.Context, *emptypb.Empty) (*BaseResultResponse, error) {
...
func _ProfileService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProfileService_Ping_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServiceServer).Ping(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
